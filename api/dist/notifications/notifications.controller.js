...
let NotificationsController = class NotificationsController {
    ...
    async findMine(user, pagination) {
        const data = await this.notificationsService.findForUser(user.id, pagination);
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List notifications for the current user (paginated)' }),
